...
//
  ...
  this.printCorrelationTable=function(){
    ...
    //debug//tr.appendChild(newHTMLTH("m1=0,m2=0"));
    //debug//tr.appendChild(newHTMLTH("m1=0,m2=1"));
    //debug//tr.appendChild(newHTMLTH("m1=1,m2=0"));
    //debug//tr.appendChild(newHTMLTH("m1=1,m2=1"));
...
//    tr.appendChild(newHTMLTH(""));
    ...
    for (var pid=cetobj.pats.length-1;pid>-1;pid--){
      ...
      //debug//tr.appendChild(newHTMLTD(cetobj.pats[pid].freqsv0v0));
      //debug//tr.appendChild(newHTMLTD(cetobj.pats[pid].freqsv0v1));
      //debug//tr.appendChild(newHTMLTD(cetobj.pats[pid].freqsv1v0));
      //debug//tr.appendChild(newHTMLTD(cetobj.pats[pid].freqsv1v1));
