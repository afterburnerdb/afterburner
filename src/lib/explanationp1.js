...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
function explanationTablep1(tabname, numpats, samplesize, binatt){
...
function bench_explainp1(tabname,summaryrows,samplesize){
  var runtimes=[];
  var kldivs=[];
  tt1=get_time_ms(); 
  for (var c=0;c<10;c++){
    var et = new explanationTablep1(tabname,summaryrows,samplesize,'p');
    t0=get_time_ms(); 
    et.explain(); 
    t1=get_time_ms();
    runtimes.push(t1-t0);
